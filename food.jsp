    ...
    <body>
     ...
     %>
      ...
      <div class="main">
            ...
            <%
            MyCon x=new MyCon();
			Connection c2=x.tcon();
			PreparedStatement pst4=c2.prepareStatement("select rname from restaurent where run=?");
			pst4.setString(1,un);
       ...
       ResultSet rs=pst.executeQuery();
        ...
        <div class="right">
            ...
            <%
             PreparedStatement pst1=c1.prepareStatement("select * from food where rname=?");
           ...
           <tr><td><%=rs1.getString("fid")%></td>
            ...
            <td><%=rs1.getFloat("price")%></td>
               ...
               <td><img src="<%=rs1.getString("fimg")%>" width="50" height="50"></td>
                ...
                <td><a href="upimgfood.jsp?fid=<%=rs1.getString("fid")%>">Update</a></td>
